...
<div class="perfil-container">
    <div class="perfil-header">
        <img src="../uploads/<?= htmlspecialchars($usuario['foto']) ?>" alt="Foto do usuário" class="foto-perfil">
        <div class="perfil-info">
            ...
            < class="seguidores">
                ...
                <a href="seguindo.php"></a><span><strong><?= $usuario['seguindo'] ?></strong> Seguindo</span></
            </div>
            <div class="botoes">
                ...
                <button class="btn excluir" onclick="abrirModalExcluirPerfil()">Excluir perfil</button>
            </div>
        </div>
    </div>
